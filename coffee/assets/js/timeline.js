...
(function (global) {
  ...
  /* ── palette ─────────────────────────────────────────────────
     ...
     reflects light in it is a coffee colour. The only cool value
     in the project is the daylight coming through the café
     window, and it exists so the warm side has something to be
     warm against. */
  ...
  var P = {
    ...
    roomTop:   [0.070, 0.062, 0.062],
    roomFloor: [0.030, 0.020, 0.014],
    roomWin:   [2.30, 1.86, 1.42],
    roomBounce:[0.115, 0.068, 0.038],
  ...
  Timeline.prototype.buildText = function () {
    this.stage.addText('hours', [
      { text: 'IN THE', scale: 0.44, weight: 200, tracking: 0.42 },
      { text: 'DARK HOURS', scale: 0.66, weight: 300, tracking: 0.10 }
    ]);
    this.stage.addText('mark', [
      { text: 'NOCTURNE', scale: 0.80, weight: 300, tracking: 0.16 }
    ]);
  };
