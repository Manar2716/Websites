...
(function (global) {
  ...
  Stage.prototype.build = function () {
    ...
    this.beans = new PEET.Bodies(tier.beans).shell({
  ...
  Stage.prototype.buildMachine = function () {
    ...
    function pool(list, key) {
      var b = new PEET.Bodies(list.length);
